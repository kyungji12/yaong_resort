...
<html>
	...
	<!-- 꼬리부분 -->
			...
			if(onlogin == null){			
			%>
			<button class="login" onclick="location.href='?contentPage=adm_login.jsp'" style="width:auto;">관리자 로그인</button>
			<%	return;
			}
			...
			%>
			<button class="login" onclick="location.href='?contentPage=adm_logout.jsp'" style="width:auto;">관리자 로그아웃</button>
			<%
			}
			%>
