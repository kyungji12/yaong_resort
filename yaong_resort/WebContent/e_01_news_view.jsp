	...
	<body><!-- 메인부분-->
			...
			%>
				<div class="row">
					...
					<button class="button" type="button" onclick="location.href='?contentPage=e_01_news.jsp'">목록</button>
			...
			if(onlogin == null || !onlogin.equals("yes")){
					...
					<button class="button" type="button" onclick="location.href='?contentPage=e_01_news_delete.jsp?id=<%=newsid%>'">삭제</button>
					<input class="button" type="submit" value="수정" formaction='?contentPage=e_01_news_update.jsp'>
					<%} %>					
				</div>
			</form>
			</div>		
