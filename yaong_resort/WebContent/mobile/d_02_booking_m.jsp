...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	* {
	...
	.select-selected:after {
		...
		border-color: #bababd transparent transparent transparent;
		/*삼각형 색 & 테두리*/
	}
		...
		<div class="row">
			<div class="col-75">
				<div class="bookingcontainer">
					<form name="insert" onsubmit='return input_check();' method="post" action="d_02_booking_write_m.jsp">

						<div class="row">
							<div class="col-50">
								<h3>예약자 정보</h3>
								<label for="bookname"><i class="fa fa-user"></i> 성함</label>
								 <input type="text" maxlength='10' id="bookname" name="bookname" placeholder="윤까망" required>
								 <label for="bookemail"><i class="fa fa-envelope"></i> 이메일</label>
								 <input type="text" maxlength='25' id="bookemail" name="bookemail" placeholder="rubyruby@example.com" required>
								 <label for="bookphone"><i class="fa fa-address-card-o"></i> 핸드폰 번호</label>
								 <input type="text" maxlength='13' id="bookphone" name="bookphone" placeholder="연락 가능한 전화번호를 남겨주세요." required>
							</div>

							<div class="col-50">
								<h3>예약 사항</h3>
								<label for=bookname2>입금자명</label>
								<input type="text" maxlength='10' id="bookname2" name="bookname2" placeholder="윤루비" required>
								<label for="bookdate">예약일<span style="color:grey;font-size:0.8em;"> (오늘 날짜부터 한달 내에만 예약이 가능합니다.)</span></label> 
							    <input type="date" id="bookdate" name="bookdate" min=<%=startDate %> max=<%=endDate %> required>
								<div class="row">
									<div class="col-50">
