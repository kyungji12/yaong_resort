...
<!-- 			<form method='post' name='form'> -->
			...
			%>
				<div class="row">
					<button class="button" type="button" onclick="location.href='e_02_review_delete_m.jsp?id=<%=reviewid %>'">삭제</button>
					<input type="submit" value="수정" formaction='e_02_review_update_m.jsp'>
					<input type="submit" value="답글" formaction='e_02_review_reinsert_m.jsp'>
					<button class="button" type="button" onclick="location.href='e_02_review_m.jsp'">목록</button>					
				</div>
			</form>
			</div>
