...
<!-- 메인부분--> 
			...
			out.println("<form name='insert' onsubmit='return input_check();'method='post' action='e_01_news_write_m.jsp' enctype='multipart/form-data'>");
			...
			<button class='button' type='button' onclick="location.href='e_01_news_m.jsp'">취소</button>     
			</div>
			</form>
			</div>
