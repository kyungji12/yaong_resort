...
////////글쓴이 이름 유효성 검사
	...
	<!-- 메인부분-->
			<h2>후기 작성</h2>
			<p>후기를 작성해주신 고객님 중 세분을 선정하여 매달 소정의 선물을 드리고있습니다. 많은 참여 바라겠습니다 :)</p>
			<br>
			<hr class="new3"><br>
			<div class="insertcontainer">
			<form name="insert" onsubmit='return input_check();' method="post" action="?contentPage=e_02_review_write.jsp" enctype="multipart/form-data">
				<div class="row">
			      <div class="col-25">
