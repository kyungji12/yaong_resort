...
////////글쓴이 이름 유효성 검사
	...
	//e_02_review_view.jsp에서 원글 id값 받아오기
	String reviewID = request.getParameter("reviewid");
	//out.println(reID);  //원글 id확인완료
	...
	<!-- 메인부분-->
			...
			<form name="insert" onsubmit='return input_check();' method="post" action="?contentPage=e_02_review_rewrite.jsp" enctype="multipart/form-data">
			<input type='hidden' value='<%=reviewID %>' name='reviewid'>
				<div class="row">
			      ...
			      <div class="col-75">
			        <input type="text" id="title" maxlength="50" name="retitle" required placeholder="제목을 입력해주세요.">
			      </div>
			    </div>
			    <div class="row">
			      <div class="col-25">
			      ...
			      <div class="col-75">
			        <input type="text" id="name" name="rename" maxlength="20" required placeholder="성함을 입력해주세요.">
			      </div>
			    </div>
			    <div class="row">
			      <div class="col-25">
			      ...
			      <div class="col-75">
			        <textarea id="recontent" name="recontent" maxlength="500" required placeholder="최대 500자까지만 입력가능합니다." style="height:200px"></textarea>
			      </div>
			    </div>
			    <div class="row">
			    	<div class="col-25">
			      ...
			      <div class="col-75">
			        <input type="file" id="imgInp" name="refile" />
